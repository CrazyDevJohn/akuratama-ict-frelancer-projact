    ...
    <div className="bg-light-400  w-[300px] flex justify-center items-center flex-col rounded-xl overflow-hidden">
      ...
      <div className="w-full px-2 py-3 bg-light-300">
        <div className="flex justify-evenly items-center gap-3">
          <button onClick={()=>hanldeApruale()} className="px-4 py-2 bg-blue-500 cursor-pointer rounded-md my-2 mx-auto w-full hover:bg-red-400 text-light-400 font-semibold text-xl">
            Apruve
          </button>
